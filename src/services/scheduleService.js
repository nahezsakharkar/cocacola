...
export async function createGroup(formValues) {
  ...
  const response = await http.post(baseURL + "api/groups/save", formValues, {
    headers: {
...
export async function createStep(formValues) {
  const user = JSON.parse(localStorage.getItem(sessionKey));
  const response = await http.post(baseURL + "api/steps/save", formValues, {
    headers: {
      Authorization: user.jwtToken,
    },
  });
...
export async function updateSequence(formValues) {
  ...
  const response = await http.post(
    baseURL + "api/steps/updateSequence",
    formValues,
    {
      headers: {
        Authorization: user.jwtToken,
...
export async function createFilter(formValues) {
  const user = JSON.parse(localStorage.getItem(sessionKey));
  const response = await http.post(baseURL + "api/filters/save", formValues, {
    headers: {
      Authorization: user.jwtToken,
    },
  });
...
export async function getGroupsByScheduleStatus(scheduledStatus) {
  ...
  const response = await http.get(
    baseURL + "api/groups/byScheduledStatus?scheduledstatus=" + scheduledStatus,
    {
      headers: {
        Authorization: user.jwtToken,
        Companyid: user.companyid,
...
export async function getGroupsByRunningStatus(RunningStatus) {
  ...
  const user = JSON.parse(localStorage.getItem(sessionKey));
  const response = await http.get(
    baseURL + "api/groups/byRunningStatus?runningstatus=" + RunningStatus,
    {
      headers: {
        Authorization: user.jwtToken,
      },
...
export async function getActiveJobsQueries() {
  const user = JSON.parse(localStorage.getItem(sessionKey));
  const response = await http.get(
    baseURL + "api/joblogs/report?jobstatus=Running",
    {
      headers: {
        Authorization: user.jwtToken,
        Companyid: user.companyid,
...
export async function getAllJobLogs(pageSize) {
  const user = JSON.parse(localStorage.getItem(sessionKey));
  const response = await http.get(
    baseURL + "api/joblogs/all?page=0&size=" + pageSize,
    {
      headers: {
        Authorization: user.jwtToken,
        Companyid: user.companyid,
